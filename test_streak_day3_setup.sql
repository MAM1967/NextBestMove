-- Test 5.3: Day 3 Recovery Email - Setup SQL
...
-- Set streak_count to 0 and last_action_date to 3 days ago
UPDATE users
SET 
  streak_count = 0,
  last_action_date = (CURRENT_DATE - INTERVAL '3 days')::date,
...
FROM users
WHERE email = 'mcddsl@icloud.com';
-- Should show: streak_count = 0, days_inactive_js_calc = 3
