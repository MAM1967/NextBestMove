...
export NEXT_PUBLIC_SUPABASE_ANON_KEY="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFkZ2lwdHpieG56ZGRiZ2ZldXV0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ4Nzk0MzIsImV4cCI6MjA4MDQ1NTQzMn0.ux0Hwx3zKUDqjYz1_6nJJqSQ8lHUkezcLl-m8VDZWUQ"
...
echo ""
echo "⚠️  IMPORTANT: You must 'source' this script (not just run it) for variables to persist:"
echo "   source tests/setup-env.sh"
echo ""
echo "Then run tests with: npm run test:staging"
echo ""
echo "Or run both in one command:"
echo "   source tests/setup-env.sh && npm run test:staging"
