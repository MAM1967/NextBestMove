    ...
    <div className="space-y-6 p-6">
      ...
      {dailyPlan && totalCount > 0 && (
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
          ...
          <div className="mt-2 h-2 w-full rounded-full bg-zinc-100 overflow-hidden" style={{ position: 'relative' }}>
            <div
              style={{
      ...
      {regularActions.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-zinc-900">Your Actions</h2>
      ...
      {!dailyPlan && (
        <div className="rounded-xl border border-zinc-200 bg-white p-12 text-center">
          <div className="mx-auto max-w-md">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              Your daily plan will appear here once it&apos;s generated. Check back
              later or generate a plan now.
            </p>
